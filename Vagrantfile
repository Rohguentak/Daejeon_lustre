...
#{MGMT_NET_PFX}.22 oss2.local oss2
  ...
  config.vm.provision 'shell', inline: 'cp -f /vagrant/epel_7.repo /etc/yum.repos.d/epel.repo && cp /vagrant/RPM-GPG-KEY-EPEL-7 /etc/pki/rpm-gpg/ && yum repolist'
  ...
  config.vm.define 'iscsi' do |iscsi|
    ...
    iscsi.vm.box='centos/7.7'
    iscsi.vm.box_url = 'http://cloud.centos.org/centos/7/vagrant/x86_64/images/CentOS-7-x86_64-Vagrant-2001_01.VirtualBox.box'
    iscsi.vm.box_download_checksum = 'e1a26038fb036ab8e76a6a4dfcd49856'
    iscsi.vm.box_download_checksum_type = 'md5'
  ...
  config.vm.define 'adm', primary: true do |adm|
    ...
    adm.vm.box = 'centos/7.7'
    adm.vm.box_url = 'http://cloud.centos.org/centos/7/vagrant/x86_64/images/CentOS-7-x86_64-Vagrant-2001_01.VirtualBox.box'
    adm.vm.box_download_checksum = 'e1a26038fb036ab8e76a6a4dfcd49856'
    adm.vm.box_download_checksum_type = 'md5'
  ...
  (1..2).each do |i|
    config.vm.define "mds#{i}" do |mds|
      ...
      #mds.vm.box = "bento/centos-6.6"
      #mds.vm.box_version = "2.1.0"
      mds.vm.box = 'centos/7.7'
      mds.vm.box_url = 'http://cloud.centos.org/centos/7/vagrant/x86_64/images/CentOS-7-x86_64-Vagrant-2001_01.VirtualBox.box'
      mds.vm.box_download_checksum = 'e1a26038fb036ab8e76a6a4dfcd49856'
      mds.vm.box_download_checksum_type = 'md5'
  ...
  (1..2).each do |i|
    config.vm.define "oss#{i}",
      ...
      oss.vm.box = 'centos/7.7'
      oss.vm.box_url = 'http://cloud.centos.org/centos/7/vagrant/x86_64/images/CentOS-7-x86_64-Vagrant-2001_01.VirtualBox.box'
      oss.vm.box_download_checksum = 'e1a26038fb036ab8e76a6a4dfcd49856'
      oss.vm.box_download_checksum_type = 'md5'
      #oss.vm.box = "bento/centos-6.6"
      #oss.vm.box_version = "2.1.0"
  ...
  (1..8).each do |i|
    config.vm.define "client#{i}",
     ...
     # c.vm.box = "hnakamur/centos7.0-x64"
     # c.vm.box_version = "0.1.0"
      c.vm.box = "hnakamur/centos7.0-x64"
      c.vm.box_version = "0.1.0" 
     # Admin / management network
...
def provision_mgmt_net(config, num)
  interface_name = if OS.windows? then 'VirtualBox Host-Only Ethernet Adapter' else 'vboxnet1' end
...
def configure_ntp_docker(config)
  config.vm.provision 'configure-ntp-docker',type: 'shell',run: 'never',path: 'scripts/configure_ntp.sh',
                         args: ["10.73.10.1"]
end
